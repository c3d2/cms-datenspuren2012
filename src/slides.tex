...
\begin{frame}
    \frametitle{Motivation}
    \begin{figure}
        \includegraphics[height=0.7\textheight]{img/computer_user.jpg}
        \license[http://www.flickr.com/photos/garethjmsaunders/1771216635/]{\cc{by-sa}}
    \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[height=0.6\textheight]{img/prototype.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item<2-> Grundlage für Verständnis
    \item<3-> Internet ist mehr als Facebook und Google
    \item<4-> Dezentralität
  \end{itemize}
\end{frame}
